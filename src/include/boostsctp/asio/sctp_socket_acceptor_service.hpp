#ifndef BOOST_ASIO_SCTP_SOCKET_ACCEPTOR_SERVICE_HPP
#define BOOST_ASIO_SCTP_SOCKET_ACCEPTOR_SERVICE_HPP
...
#else
  : public boost::asio::detail::service_base< sctp_socket_acceptor_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit sctp_socket_acceptor_service(boost::asio::io_context& io_context)
    : boost::asio::detail::service_base<
        sctp_socket_acceptor_service<Protocol> >(io_context),
      service_impl_(io_context)
  {
	...
	void move_assign(implementation_type& impl, sctp_socket_acceptor_service& other_service,
	...
	template <typename Protocol1> friend class sctp_socket_acceptor_service;

  /// Move-construct a new socket acceptor implementation from another protocol
  /// type.
	template <typename Protocol1>
	void converting_move_construct(implementation_type& impl,
	  sctp_socket_acceptor_service<Protocol1>& other_service,
	  typename sctp_socket_acceptor_service<
  ...
  {
    service_impl_.bind(impl, endpoints, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
